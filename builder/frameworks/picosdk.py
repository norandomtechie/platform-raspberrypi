...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_boot_lock"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_clocks", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_clocks"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_divider", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_divider"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_dma", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_dma"),
        ...
        join(FRAMEWORK_DIR, "src", "rp2_common", "hardware_xosc"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_aon_timer", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_aon_timer"),
        ...
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_rand"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_runtime_init", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_runtime_init"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_runtime", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_runtime"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_sha256", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_sha256"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_standard_binary_info", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_standard_binary_info"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_stdlib", "include"),
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_stdlib"),
        ...
        join(FRAMEWORK_DIR, "src", "rp2_common", "pico_cyw43_driver"),
